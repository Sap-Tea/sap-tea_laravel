...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            ...
            @auth('funcionario')
                <span class="navbar-text ms-auto" style="font-weight:500;">
                    {{ explode(' ', trim(auth('funcionario')->user()->func_nome))[0] }}
                    {{ collect(explode(' ', trim(auth('funcionario')->user()->func_nome)))->last() }}
                </span>
            @endauth
        </div>
    </nav>
